...
\vspace*{3.49cm}% start 8 cm from the top of the page}
    ...
    \vspace*{1.2cm} % text starts 1cm under the top of the minipage
        ...
        % Driven by my passion for learning and technology, I approached the ICT world during high school and delved into the subject until I graduated in Computer Science. Between my bachelor's and master's degrees, I worked in the field for a year to better understand which specialization was the most suitable for me. I have now completed my master's degree in Autonomous Systems, and I know that my primary goal is to develop software solutions for robots, as this will allow me to use the wide range of knowledge I've acquired throughout my education. Robotics, control, and deep learning are the subjects I prefer, and I am eager to apply them to my next challenge!
        ...
        \begin{center}
            \cvtag{Automatic Control}\cvtag{Software Engineering}\cvtag{Robotics}\cvtag{Mechatronics}\cvtag{AI}\cvtag{ML}\cvtag{Deep Learning}\cvtag{Algorithms}\cvtag{Data Structures}\cvtag{Sensor Fusion}\cvtag{Applied Estimation}\cvtag{Dynamic Modeling}\cvtag{Full Stack Development}\cvtag{OOP}\cvtag{SCRUM}
        \end{center}
    \end{minipage}} %
    \hfill 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% MAIN SECTION %%%%%%%%%%%%%%%%%%%%
    \adjustbox{valign=t}{\begin{minipage}{11.3cm}
       ...
       % \vspace*{0.18cm}
        ...
        \MySection{sep 2017-\\jul 2020}{}{BSc Computer Science}{University of Trento}{Trento, Italy}{}{
        \\ 
        ...
        \MySection{sep 2014-\\jul 2017}{}{HS Computer Science}{ITT Marconi Rovereto}{Rovereto, Italy}{}{
        \\ 
        ...
        % Safety-critical teleoperation, Shared Autonomy\\
        }{I joined the team to develop the research project for my master's degree. The result is a control algorithm for teleoperation aware of physical obstacles and network delays; the approach can be found in the publication at the \href{https://arxiv.org/pdf/2403.18650}{link}.\\
        ...
        }{I joined the company as an intern and finally developed there my bachelor's degree. The main focus was to interface with the company's APIs and access their datasets to develop a web application.} 
